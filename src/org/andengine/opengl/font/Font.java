...
public class Font implements IFont {
    ...
    public Font(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize, final boolean pAntiAlias,
            final Color pColor) {
    ...
    private Letter createLetter(final char pCharacter) throws FontException {
        ...
        if (whitespace) {
            ...
            letter = new Letter(pCharacter, this.mCurrentTextureX - Font.LETTER_TEXTURE_PADDING, this.mCurrentTextureY - Font.LETTER_TEXTURE_PADDING,
                    letterWidth, letterHeight, letterLeft, letterTop, advance, u, v, u2, v2);
    ...
    public float getRemainSpacePercent() {
        return this.mCurrentTextureY / (float) this.mTextureHeight;
    }
